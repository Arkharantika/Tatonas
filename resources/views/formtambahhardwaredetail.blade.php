        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tambah Data Hardware Detail</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
    ...
    <div class="main-body">
        <div class="row">
            <div class="col mx-auto">
                <div class="card">
                    <div class="card-body">
                        <div class="text-center"><i class="bx bxs-grid text-dark font-50"></i>
                            <h4 class="form-label ">Form Tambah Hardware Detail</h4>
                        ...
                        <form method="post" action="{{url('/hardwaredetail/createdata')}}"
