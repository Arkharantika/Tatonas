        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Data Transaction Detail</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center"><i class="bx bxs-data text-dark font-50"></i>
                            <h4 class="form-label ">Form Update Transaction Detail</h4>
                        ...
                        <form method="post" action="{{$item->id}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="number" class="form-control" value="{{$item->trans_id}}" name="trans_id" id="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="number" class="form-control" value="{{$item->hardware}}" name="hardware" id="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="number" step="0.01" class="form-control" value="{{$item->value}}" name="value" id="" required>
                                </div>
                            </div>
