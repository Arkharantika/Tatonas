        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tambah Data Master Sensor</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center"><i class="bx bx-dialpad-alt text-dark font-50"></i>
                            <h4 class="form-label ">Form Tambah Master Sensor</h4>
                        ...
                        <form method="post" action="{{url('/mastersensor/createdata')}}" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="" name="sensor_name" id="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="" name="unit" id="" required>
                                </div>
                            </div>
