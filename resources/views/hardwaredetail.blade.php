...
<div class="container">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">List Data Hardware Detail</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
    ...
    <hr />
    <p class="mb-0 text-uppercase display-6 text-center">List Data Hardware Detail</p>
    <hr />
                        ...
                        <tr>
                            <div class="col-sm-9 text-secondary">
                                <a type="button" class="btn btn-outline-success mr-5"
                                    href="{{url('/hardwaredetail/tambahdata')}}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="edithardwaredetail/{{$row->id}}" class="btn btn-sm btn-warning mr-5 mb-5"><i
                                ...
                                <a href="softdeletehardwaredetail/{{$row->id}}"
                                    onclick="return confirm('Yakin untuk menghapus data ini?')"
