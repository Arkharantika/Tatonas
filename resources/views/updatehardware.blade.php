        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Data Hardware</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
    ...
    <div class="main-body">
        <div class="row">
            <div class="col mx-auto">
                <div class="card">
                    <div class="card-body">
                        <div class="text-center"><i class="bx bx-border-all text-dark font-50"></i>
                            <h4 class="form-label ">Form Update Hardware</h4>
                        ...
                        <form method="post" action="{{$item->id}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="{{$item->hardware}}" name="hardware" id="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="{{$item->location}}" name="location" id="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="{{$item->timezone}}" name="timezone" id="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">Local Time</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                    <input type="datetime-local" class="form-control" value="{{$item->local_time}}" name="local_time" id="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="{{$item->latitude}}" name="latitude" id="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="{{$item->longitude}}" name="longitude" id="" required>
                                </div>
                            </div>
