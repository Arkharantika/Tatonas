        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tambah Data Hardware</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center"><i class="bx bx-border-all text-dark font-50"></i>
                            <h4 class="form-label ">Form Tambah Hardware</h4>
                        ...
                        <form method="post" action="{{url('/hardware/createdata')}}" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="" name="location" id="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="" name="timezone" id="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="datetime-local" class="form-control" value="" name="local_time" id="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="" name="latitude" id="" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="" name="longitude" id="" required>
                                </div>
                            </div>
