        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Data Transaction</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center"><i class="bx bx-transfer-alt text-dark font-50"></i>
                            <h4 class="form-label ">Form Update Transaction</h4>
                        ...
                        <form method="post" action="{{$item->id}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="{{$item->created_by}}" name="created_by" id="" required>
                                </div>
                            </div>
